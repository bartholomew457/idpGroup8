...
def grandFatherClockDisplay():
    global clockHour, clockMinute, manRot, timeMin, turningCog
    ...
    if pygame.mouse.get_pressed()[0]:
        ...
        if timeMin >= 714 and timeMin <= 716:
            ...
            forceCustomDialogue(3, ["A candle!", "I just need something to light this!"], ["player/cedricHeadshot.png", "player/cedricHeadshot.png"])
